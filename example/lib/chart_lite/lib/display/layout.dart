...
class Layout {
  ...
  static Layout fromJson(Map<String, dynamic> x) {
    var layout = Layout();
...
class AnchorXAxis {
  ...
  static final values = <String>['free', 'x', 'x2', 'x3', 'x4'];
...
class AnchorYAxis {
  ...
  static final values = <String>['free', 'y', 'y2', 'y3', 'y4'];
...
enum LegendToggleOption { toggle, toggleOthers, none }
...
class AxisTitle {
  ...
  static AxisTitle fromMap(Map<String, dynamic> x) {
    var title = AxisTitle();
...
enum Orientation {
  ...
  const Orientation(this._value);
  final String _value;

  static Orientation parse(String value) {
    return switch (value) {
